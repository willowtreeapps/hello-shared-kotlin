...
class Log {
 ...
 //    writeKey: "304DBBC3331FB92901CB9A2AEFAA81BC35A9D05B6B65FCB84DB8E2A7C95A5E657948C604659A12664AEC33A6BFE64F0E465F61BDE631F528CBC0C181E9A9640FE56DC651DB13F9145887B2170155D01F6CAB1EEBFDFB7F72918C32B81B8252E1"
	 ...
	 */
	verbose(caller: string, message: string, data?: any): void {
		if (data === undefined) {
	 ...
	 * @param data?		   Any additional data to log
	 */
	info(caller: string, message: string, data?: any): void {
		if (data === undefined) {
	 ...
	 * @param data?      Any additional data to log
	 */
	warn(caller: string, message: string, data?: any): void {
		if (data === undefined) {
	 ...
	 * @param data?		   Any additional data to log
	 */
	error(caller: string, message: string, data?: any): void {
 ...
 //  }
  ...
  // }
	 ...
	 */
  disconnected(id: string, matchName: string, reason: any): void {
	 ...
	 */
  reconnected(matchName: string, id: string): void {
